    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.producer')),
                ('workplace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.workplace')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waybill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.waybilllist')),
            ],
        ),
        migrations.CreateModel(
            name='RestsStock',
            fields=[
                ...
                ('fa', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='API.fa')),
                ('fb', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='API.fb')),
                ('rest_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.restslist')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='alcohol',
            name='v_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.vcode'),
        ),
    ]
